...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-01-16T23:50:07Z"), u1);
		Order o2 = new Order(null, Instant.parse("2024-01-16T01:50:07Z"), u2);
		Order o3 = new Order(null, Instant.parse("2024-01-16T02:50:07Z"), u1);
